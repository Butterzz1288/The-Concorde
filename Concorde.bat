...
SET col[full]="500;162;225" "203;204;124" "121;199;173"
SET bird[full]="" "" ""
SET "pipe[bdy]=║"
SET "pipe[top]=╥"
SET "pipe[btm]=╨"
...
SETLOCAL
TITLE The Concorde
ECHO %ESC%[?25l%ESC%[48;2;55;128;128m%ESC%[2J%ESC%[38;2;212;172;87m%ESC%[8;11HThe Concorde %ESC%[9;9HHigh Score : !score[high]!%ESC%[11;9H[Press W]%ESC%[%bird[y]%;10H%ESC%[38;2;!col[%bird[rand]%]!m%bird[cur]%%ESC%[23;1H%ESC%[48;2;50;168;82m%ESC%[38;2;133;110;48m▲_▲_▲_▲_▲_▲_▲_▲_▲_▲_▲_▲_▲_▲_▲_%ESC%[0m
ECHO %random%/KM %random%/KPH
PAUSE>NUL
...
:GAME
TITLE Press W to Jump- Spinning Rage v1.0 Beta
FOR /L %%# in () DO (
    SET /P "input="
    IF defined input (
        SET "bird[jmp]=4"
